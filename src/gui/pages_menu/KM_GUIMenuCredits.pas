...
begin
  ...
  Panel_Credits.AnchorsStretch;
    ...
    Label_Credits_Remake := TKMLabelScroll.Create(Panel_Credits, aParent.Width div 2 - OFFSET, 110, 0, aParent.Height - 130,
      ...
      gResTexts[TX_CREDITS_ADDITIONAL_PROGRAMMING] + '|Alex|andreus|Danjb|ZblCoder|Gelwe (WarmachineMod)||' +
      gResTexts[TX_CREDITS_ADDITIONAL_GRAPHICS] + '|StarGazer|Malin|H.A.H.|Siegfried89 (WarmachineMod)|Knights Dzapan (WarmachineMod)||' +
