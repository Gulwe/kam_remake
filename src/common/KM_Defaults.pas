...
const
  ...
  UNIT_CONDITION_BASE        = 1.0;        //Base amount of health a unit starts with (measured in KaM)
  UNIT_CONDITION_RANDOM      = 0.1;        //Random jitter of unit's starting health (KaM did not have this, all units started the same)
  TROOPS_TRAINED_CONDITION   = 1.0;        //Condition troops start with when trained (measured from KaM)
