...
const //TowerRock position is a bit different for reasons said below
  OFFSET_X: array [TKMProjectileType] of Single = (0.5, 0.5, 0.5, -0.25, 0.5, 0.5); //Recruit stands in entrance, Tower middleline is X-0.75
  OFFSET_Y: array [TKMProjectileType] of Single = (0.2, 0.2, 0.2, -0.2, 0.5, 0.5); //Add towers height
var
  I: Integer;
begin
  I := -1;
  ...
  for I := 0 to Length(fItems) - 1 do
    ...
    begin
      ...
      case fItems[I].fType of
        ptArrow, ptSlingRock, ptBolt, ptCatapultRock, ptBallistaRock:
          begin
